...
const problems = [
  {
    ...
    difficulty: 'Easy',
    tags: ['array', 'hashmap'],
    statement: 'Given an array of integers, return indices of the two numbers such that they add up to a specific target. It is guaranteed that such pair exists. If there are multiple such pairs present then return the first pair when arranged in ascending order',
    ...
    hiddencases: [
      { input: '4 2 7 11 15 9', output: '[0,1]' },
      { input: '3 3 2 4 6', output: '[1,2]' },
      { input: '5 2 22 20 100000 4 26', output: '[1,4]'},
      { input: '5 1 2 3 4 5 9', output: '[3,4]'},
      { input: '4 -10 -20 -35 -44 -55', output: '[1,2]'},
      { input: '2 1000000 1000000 2000000', output: '[0,1]'}
    ]
  },
  {
    id: 'reverse-string',
    ...
    hiddencases: [
      ...
      { input: 'The quick brown fox', output: 'xof nworb kciuq ehT' }
    ]
  }
];
